...
import { pegar_data, add_user, pegar_musicas, add_musica, login, albuns_artista, pegar_musicas_artista } from "../controller/controller.js"
...
router.get("/perfil/:nome_artistas", albuns_artista)
